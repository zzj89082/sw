 	...
 	<section class="wrapper">   
	    ...
	    <div class="form">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="cname" class="control-label col-lg-2">轮播图ID<span class="required">*</span></label>
                  <div class="col-lg-9">
                      <input class="form-control" id="cname" name="config_rollimg" minlength="5" type="text" disabled="">
                  </div>
              </div>
              <div class="form-group">
